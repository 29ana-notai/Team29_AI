...
class STTModel:
    ...
    def transcribe(self, audio_data):
        try:
            ...
            if self.use_faster_whisper:
                ...
                result = self._transcribe_whisper(preprocessed_audio)

            words_with_timestamps = self._normalize_timestamps(result['words'], result['audio_length'])
    ...
    def _transcribe_whisper(self, preprocessed_audio):
    ...
    def _normalize_timestamps(self, words, audio_length):
